...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public class ZipOutputStream : DeflaterOutputStream
    {
        ...
        public void SetComment(string comment)
        {
            ...
            if (commentBytes.Length > 0xffff) throw new ArgumentOutOfRangeException("comment");
        ...
        public void PutNextEntry(ZipEntry entry)
        {
            ...
            if (Password != null)
            {
                ...
                if (entry.Crc < 0) // Need to append a data descriptor as the crc isnt available for use
            ...
            if (UseZip64 == UseZip64.On || entry.Size < 0 && UseZip64 == UseZip64.Dynamic) entry.ForceZip64();
        ...
        public void CloseEntry()
        {
            ...
            if (patchEntryHeader)
            {
                ...
                {
                    if (sizePatchPos == -1) throw new ZipException("Entry requires zip64 but this has been turned off");
        ...
        public override void Finish()
        {
            ...
            foreach (ZipEntry entry in entries)
            {
                ...
                if (entryComment.Length > 0xffff) throw new ZipException("Comment too long.");
        ...
        private static void AddExtraDataAES(ZipEntry entry, ZipExtraData extraData)
        {
            ...
            extraData.AddLeShort((int) entry
                .CompressionMethod); // The actual compression method used to compress the file
