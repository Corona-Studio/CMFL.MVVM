...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public sealed class ZipConstants
    {
        ...
        ///     But sometimes it yields the special value of 1 which is nicknamed <c>CodePageNoOEM</c> in <see cref="Encoding" />
        ...
        ///     So replace it with some fallback, e.g. 437 which is the default cpcp in a console in a default Windows
        ///     installation.
        /// </remarks>
        private static int defaultCodePage =
            ...
            Thread.CurrentThread.CurrentCulture.TextInfo.OEMCodePage == 2 ||
            Thread.CurrentThread.CurrentCulture.TextInfo.OEMCodePage == 3 ||
