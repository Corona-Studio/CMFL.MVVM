...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public class ZipEntry : ICloneable
    {
            ...
            CompressionMethod method)
        {
            ...
            if (name.Length > 0xffff) throw new ArgumentException("Name is too long", "name");
        ...
        /// </summary>
        public bool IsDOSEntry => HostSystem == (int) HostSystemID.Msdos ||
        ...
        /// </remarks>
        public bool CanDecompress => Version <= ZipConstants.VersionMadeBy &&
                                     (Version == 10 ||
                                      Version == 11 ||
                                      Version == 20 ||
                                      Version == 45 ||
        ...
        public long Crc
        {
            ...
            set
            {
                if ((crc & 0xffffffff00000000L) != 0) throw new ArgumentOutOfRangeException("value");
                crc = (uint) value;
                known |= Known.Crc;
            }
        }
        ...
        /// </summary>
        internal CompressionMethod CompressionMethodForHeader => AESKeySize > 0 ? CompressionMethod.WinZipAES : method;
        ...
        public byte[] ExtraData
        {
            ...
            set
            {
                ...
                {
                    if (value.Length > 0xffff) throw new ArgumentOutOfRangeException("value");
        ...
        internal void ProcessExtraData(bool localHeader)
        {
            ...
            if (extraData.Find(0x0001))
            {
                ...
                if (localHeader || size == uint.MaxValue) size = (ulong) extraData.ReadLong();

                if (localHeader || compressedSize == uint.MaxValue) compressedSize = (ulong) extraData.ReadLong();
            ...
            if (extraData.Find(10))
            {
                ...
                if (extraData.ValueLength < 4) throw new ZipException("NTFS Extra data invalid");
        ...
        private void ProcessAESExtraData(ZipExtraData extraData)
        {
            ...
            if (extraData.Find(0x9901))
            {
                ...
                var length = extraData.ValueLength; // Data size currently 7
                if (length < 7)
                    throw new ZipException("AES Extra Data Length " + length + " invalid.");
                var ver = extraData.ReadShort(); // Version number (1=AE-1 2=AE-2)
                var vendorId = extraData.ReadShort(); // 2-character vendor ID 0x4541 = "AE"
                var encrStrength = extraData.ReadByte(); // encryption strength 1 = 128 2 = 192 3 = 256
                var actualCompress = extraData.ReadShort(); // The actual compression method used to compress the file
                _aesVer = ver;
        ...
        public static string CleanName(string name)
        {
            ...
            if (Path.IsPathRooted(name)) // NOTE:
