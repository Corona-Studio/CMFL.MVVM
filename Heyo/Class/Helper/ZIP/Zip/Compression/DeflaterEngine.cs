...
namespace ICSharpCode.SharpZipLib.Zip.Compression
{
    ...
    public class DeflaterEngine : DeflaterConstants
    {
        ...
        public void SetInput(byte[] buffer, int offset, int count)
        {
            ...
            */
            if (offset > end || end > buffer.Length) throw new ArgumentOutOfRangeException("count");
        ...
        public void Reset()
        {
            ...
            for (var i = 0; i < HASH_SIZE; i++) head[i] = 0;

            for (var i = 0; i < WSIZE; i++) prev[i] = 0;
        }
...
*/
        ...
        private bool DeflateFast(bool flush, bool finish)
        {
            ...
            while (lookahead >= MIN_LOOKAHEAD || flush)
            {
                ...
                if (strstart > 2 * WSIZE - MIN_LOOKAHEAD) /* slide window, as FindLongestMatch needs this.
            ...
            while (lookahead >= MIN_LOOKAHEAD || flush)
            {
                ...
                if (lookahead >= MIN_MATCH)
                {
                    ...
                    if (Strategy != DeflateStrategy.HuffmanOnly &&
                        hashHead != 0 &&
                        strstart - hashHead <= MAX_DIST &&
                        FindLongestMatch(hashHead)) // longestMatch sets matchStart and matchLen
