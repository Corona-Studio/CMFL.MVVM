...
namespace ICSharpCode.SharpZipLib.Encryption
{
    ...
    internal class ZipAESTransform : ICryptoTransform
    {
        ...
        public ZipAESTransform(string key, byte[] saltBytes, int blockSize, bool writeMode)
        {
            ...
            var byteKey1 = pdb.GetBytes(InputBlockSize);
            var byteKey2 = pdb.GetBytes(InputBlockSize);
            ...
            int outputOffset)
        {
            ...
            if (!_writeMode) _hmacsha1.TransformBlock(inputBuffer, inputOffset, inputCount, inputBuffer, inputOffset);
            ...
            if (_writeMode) // This does not change the buffer. 
